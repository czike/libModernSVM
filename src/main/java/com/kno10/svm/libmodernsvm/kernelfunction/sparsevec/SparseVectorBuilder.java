...
/**
 * Build pure java vectors.
 * 
 * TODO: sort if values did not arrive in proper order.
 * 
 * @author Erich Schubert
 */
public class SparseVectorBuilder implements VectorBuilder<SparseVector> {
  /**
  ...
  public SparseVector build() {
    return new SparseVector(Arrays.copyOf(idx, size), Arrays.copyOf(val, size));
  }
}
