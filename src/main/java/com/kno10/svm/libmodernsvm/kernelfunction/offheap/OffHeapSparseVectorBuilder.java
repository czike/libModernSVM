 ...
 */
public class OffHeapSparseVectorBuilder implements VectorBuilder<OffHeapSparseVector> {
  /**
  ...
  @Override
  public OffHeapSparseVector build() {
    return new OffHeapSparseVector(idx, val, size);
  }
}
